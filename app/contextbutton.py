...
class ContextButton(Window):
    ...
    def draw(self, active: bool = False) -> None:
        ...
        super().draw()
        if active:
            button_hk = curses.color_pair(ColorPairs.CONTEXT_HOTKEY_SELECTED)
            button_text = curses.color_pair(ColorPairs.CONTEXT_TEXT_SELECTED)
        else:
            button_hk = curses.color_pair(ColorPairs.CONTEXT_HOTKEY)
            button_text = curses.color_pair(ColorPairs.CONTEXT_TEXT)
